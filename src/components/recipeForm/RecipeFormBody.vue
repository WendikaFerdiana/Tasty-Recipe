            ...
            <div class="border-top my-3">
                ...
                <div>
                    <div class="mb-3 row" v-for="count in directionCount" :key="count">
                        <div class="col-lg-11 col-11">
                            <base-input type="text" identity="direction" placeholder="Ex: Stir the mixture"
                ...
                <base-button class="new-ingredient-btn px-3 py-2" type="button" @clickButton="addDirection">Add
                    More</base-button>
            </div>
